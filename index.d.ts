...
export declare class MediaPlayer {
   ...
   */
  addEventListener(eventName: 'buttonpressed' | 'positionchanged' | 'positionseeked', callback: any): void
  /** Removes an event listener from the MediaPlayer */
  removeEventListener(eventName: 'buttonpressed' | 'positionchanged' | 'positionseeked', callback: any): void
  /**
   * Adds an event listener to the MediaPlayer
   *
   * Alias for addEventListener
   */
  on(eventName: 'buttonpressed' | 'positionchanged' | 'positionseeked', callback: any): void
  /**
   * Removes an event listener from the MediaPlayer
   *
   * Alias for removeEventListener
   */
  off(eventName: 'buttonpressed' | 'positionchanged' | 'positionseeked', callback: any): void
...
export declare const enum MediaPlayerMediaType {
  Unknown = -1,
  Music = 1
}

export declare const enum MediaPlayerPlaybackStatus {
  Unknown = -1,
  Playing = 1,
  Paused = 2,
  Stopped = 3
...
export declare const enum MediaPlayerThumbnailType {
  Unknown = -1,
  File = 1,
  Uri = 2
}
