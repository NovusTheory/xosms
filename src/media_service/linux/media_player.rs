    ...
    T: OrgMprisMediaPlayer2Player + Send + 'static,
{
    cr.register("org.mpris.MediaPlayer2.Player", |b| {
        ...
        b.method("SetVolume", ("volume",), (), |_, t: &mut T, (volume,)| {
            t.set_volume_(volume)
        });
        ...
        b.property::<arg::PropMap, _>("Metadata")
            .get(|_, t| t.metadata())
            .annotate("org.qtproject.QtDBus.QtTypeName", "QVariantMap");
        b.property::<f64, _>("Volume").get(|_, t| t.volume());
