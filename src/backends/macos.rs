...
impl PlatformBackend {
    ...
    unsafe {
      ...
      Some(
        remote_command_center
          ...
          .addTargetWithHandler(&play_pause_handler),
      );
      ...
      Some(
        remote_command_center
          ...
          .addTargetWithHandler(&previous_handler),
      );
      ...
      let playback_position_handler = RcBlock::new(move |event: NonNull<MPRemoteCommandEvent>| {
        ...
        {
          let _ = callback_tx.try_send(PlatformBackendEvent::PositionChanged {
      ...
      Some(
        remote_command_center
          ...
          .addTargetWithHandler(&playback_position_handler),
      );
      ...
      let playback_rate_handler = RcBlock::new(move |event: NonNull<MPRemoteCommandEvent>| {
        ...
        {
          let _ = callback_tx.try_send(PlatformBackendEvent::RateChanged {
            rate: event.playbackRate() as f64,
          });
        }
        MPRemoteCommandHandlerStatus::Success
      });
      Some(
        remote_command_center
          ...
          .addTargetWithHandler(&playback_rate_handler),
      );
      ...
      let repeat_mode_handler = RcBlock::new(move |event: NonNull<MPRemoteCommandEvent>| {
        if let Some(event) = event
          .as_ref()
          .downcast_ref::<MPChangeRepeatModeCommandEvent>()
        {
          let _ = callback_tx.try_send(PlatformBackendEvent::LoopChanged {
            loop_type: match event.repeatType() {
      ...
      Some(
        remote_command_center
          ...
          .addTargetWithHandler(&repeat_mode_handler),
      );
      ...
      let shuffle_mode_handler = RcBlock::new(move |event: NonNull<MPRemoteCommandEvent>| {
        if let Some(event) = event
          .as_ref()
          .downcast_ref::<MPChangeShuffleModeCommandEvent>()
        {
          let _ = callback_tx.try_send(PlatformBackendEvent::ShuffleChanged {
            shuffle: match event.shuffleType() {
      ...
      Some(
        remote_command_center
          ...
          .addTargetWithHandler(&shuffle_mode_handler),
      );
    }
    ...
    unsafe {
      ...
      if let Some(thumbnail) = state.thumbnail {
        ...
        if let Some(image) = image {
          ...
          let handler =
            RcBlock::new(move |_size: NSSize| -> NonNull<NSImage> { NonNull::from_ref(&*image) });
      ...
      info.setObject_forKey(
        &NSString::from_str(&state.title),
        ProtocolObject::from_ref(MPMediaItemPropertyTitle),
      );
      info.setObject_forKey(
        &NSString::from_str(&state.album_title),
        ProtocolObject::from_ref(MPMediaItemPropertyAlbumTitle),
      );
      info.setObject_forKey(
        &NSString::from_str(&state.artist.join(", ")),
        ProtocolObject::from_ref(MPMediaItemPropertyArtist),
      );
      info.setObject_forKey(
        &NSNumber::initWithDouble(NSNumber::alloc(), state.playback_rate),
      ...
      remote_command_center
        .playCommand()
        .setEnabled(state.play_button_enabled);
      remote_command_center
        .pauseCommand()
        .setEnabled(state.pause_button_enabled);
      remote_command_center
        .stopCommand()
        .setEnabled(state.stop_button_enabled);
      remote_command_center
        .nextTrackCommand()
        .setEnabled(state.next_button_enabled);
      remote_command_center
        .previousTrackCommand()
        .setEnabled(state.previous_button_enabled);
      remote_command_center
        .changePlaybackPositionCommand()
        .setEnabled(true);
      remote_command_center
      ...
      remote_command_center
        .changeRepeatModeCommand()
        .setCurrentRepeatType(match state.r#loop {
      ...
      remote_command_center
        .changeShuffleModeCommand()
        .setCurrentShuffleType(match state.shuffle {
  ...
  pub async fn set_timeline(&mut self, duration: f64, position: f64) -> Result<(), XosmsError> {
    unsafe {
      ...
      info.setObject_forKey(
        &NSNumber::initWithDouble(NSNumber::alloc(), duration),
        ProtocolObject::from_ref(MPMediaItemPropertyPlaybackDuration),
      );
      info.setObject_forKey(
        &NSNumber::initWithDouble(NSNumber::alloc(), position),
